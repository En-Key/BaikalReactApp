      ...
      <section className={s.second_section}>
        <div className={s.second_section_container}>
          <div className={s.second_section_text}>
            ...
            <p className={s.p}>
              Озеро Байкал – это настоящая сокровищница природы. <br/>Его воды являются одними из самых чистых и прозрачных
              на Земле, а берега украшены величественными горами, пышными лесами и бескрайними степями. <br/>Байкал известен
              также своим удивительным разнообразием флоры и фауны. <br/>Здесь можно встретить множество уникальных видов
              растений и животных, в том числе и тех, которые не встречаются больше нигде на планете. <br/>Озеро Байкал также
              является местом миграции для многих видов птиц, что делает его настоящим райским уголком для фотографов
              дикой природы. Оно расположено в южной части Восточной Сибири и является самым глубоким и старым озером на
              планете. <br/>Байкал – это не просто озеро, это уникальный экосистемный комплекс, который притягивает внимание
              ученых и туристов со всего мира.
            </p>
          </div>
        ...
        {/* <Section sectionData={mockSections[0]}/>  */}
      </section>
        ...
        <div className={s.second_section_container}>
          <div className={s.second_section_text}>
            ...
            <p className={s.p}>
              ...
              множество вопросов. <br/>Мы постараемся помочь вам в этом.
            </p>
          </div>
          <div className={s.second_section_image}>
